...
FROM(
    ...
    FROM(
        ...
        FROM(
            ...
            JOIN m_product hh ON civ.m_product_id = hh.m_product_id AND hh.m_product_id = 1015087
            ...
            UNION ALL
            SELECT '7' AS id, 0 AS qty, sum(fc.amtacctdr - fc.amtacctcr) AS "tt"
                FROM fact_acct fc
                ...
                WHERE fc.C_Activity_ID = 1000272 AND ad_table_id = 321 AND  fc.C_Campaign_ID=1000060  AND fc.dateacct>='01-01-2019' AND fc.dateacct<='04-30-2019' 
          ) AS k GROUP BY id
          ) AS k 
